...
const ProjectList = () => {
  return (
    <div className="container my-24 mx-auto px-3 md:px-6">
    ...
    <div className="grid gap-x-6 lg:grid-cols-3">
      <div className="mb-12 lg:mb-0">
        <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
          <Image  src="https://mdbcdn.b-cdn.net/img/new/standard/city/041.jpg" className="w-full" alt="image" width={52} height={52}/>
          <a href="#!">
            <div
      ...
      <div className="mb-12 lg:mb-0">
        <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
          <Image alt="image" src="https://mdbcdn.b-cdn.net/img/new/standard/city/045.jpg" className="w-full" width={52} height={52} />
          <a href="#!">
            <div
              className="mask absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,0.2)]"></div>
          </a>
      ...
      <div className="mb-0">
        <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
          <Image alt="image" src="https://mdbcdn.b-cdn.net/img/new/standard/city/047.jpg" className="w-full" width={52} height={52} />
          <a href="#!">
            <div
              className="mask absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,0.2)]"></div>
          </a>
